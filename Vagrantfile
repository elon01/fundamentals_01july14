...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "ebarevan-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/elon_01july14"
  #   chef.validation_client_name = "elon_01july14-validator"
  #   chef.validation_key_path = ".chef/elon_01july14-validator.pem"
  # end
end
